...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        main_layout.setContentsMargins(
            self.margins, self.margins, self.margins, self.margins)  # Responsive margins

        # Add top spacer to push content down and create better vertical distribution
        top_spacer = QSpacerItem(20, int(60 * (self.title_font_size / 28)),
        ...
        bottom_spacer = QSpacerItem(20, int(
            40 * (self.title_font_size / 28)), QSizePolicy.Policy.Minimum, QSizePolicy.Policy.Expanding)
    ...
    def create_title_section(self, layout):
        ...
        title_label.setStyleSheet(
            f"margin-top: {int(20 * (self.title_font_size / 28))}px; margin-bottom: {int(10 * (self.title_font_size / 28))}px;")  # Responsive spacing

        subtitle_label = QLabel(
            "Advanced steganography and steganalysis platform for secure data hiding and detection.")
        subtitle_font = QFont()
        subtitle_font.setPointSize(
            self.subtitle_font_size)  # Responsive font size
        subtitle_font.setWeight(QFont.Weight.Light)  # Lighter font weight
        subtitle_label.setFont(subtitle_font)
        subtitle_label.setAlignment(Qt.AlignmentFlag.AlignCenter)
        subtitle_label.setStyleSheet(
            f"color: #D9D9D9; margin-bottom: {int(20 * (self.subtitle_font_size / 14))}px; line-height: 1.4;")  # Responsive spacing
    ...
    def create_cards_section(self, layout):
        ...
        cards_layout.setSpacing(self.card_spacing)
        cards_layout.setAlignment(Qt.AlignmentFlag.AlignCenter)
        # No extra margins on cards container
        ...
        # No extra styling for perfect centering
    ...
    def create_card(self, title, description, button_text, button_color, icon):
        ...
        responsive_spacing = max(
            int(8 * (self.card_min_width / 280)), 6)  # Minimum 6px spacing
        # Minimum 10px margin
        responsive_margin = max(int(15 * (self.card_min_width / 280)), 10)
        layout.setSpacing(responsive_spacing)
        layout.setContentsMargins(
            responsive_margin, responsive_margin, responsive_margin, responsive_margin)

        # Icon with proper centering - no borders
        icon_container = QWidget()
        # Responsive icon container height
        icon_container.setFixedHeight(self.icon_size + 20)
        ...
        title_font.setPointSize(self.card_title_font_size)
        title_font.setBold(True)
        title_label.setFont(title_font)
        title_label.setAlignment(Qt.AlignmentFlag.AlignCenter)
        ...
        responsive_font_size = max(
            self.card_desc_font_size, int(self.card_desc_font_size * 0.8))
        ...
        desc_label.setMinimumHeight(int(60 * (self.card_min_width / 280)))
        ...
        # Slightly increased responsive button height
        button.setMinimumHeight(int(40 * (self.card_min_width / 280)))
        ...
        try:
            ...
            if not pixmap.isNull():
                ...
                scaled_pixmap = pixmap.scaled(
                    self.icon_size, self.icon_size, Qt.AspectRatioMode.KeepAspectRatio, Qt.TransformationMode.SmoothTransformation)
    ...
    def create_default_icon(self):
        ...
        painter.drawEllipse(margin, margin, icon_size -
                            2*margin, icon_size - 2*margin)
        painter.end()
        return pixmap
